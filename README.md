...
Welcome to the repository for the second edition of **Building your own Code Editor** in **Seasons of Code**! This repository contains weekly tasks, curated resources, and learning materials for the **Web Development** track of the 2026 edition of **Seasons of Code**.

The project is designed to help participants build a strong foundation in **Frontend Development**, **Editor Architecture**, and modern developer tooling, covering both theoretical concepts and practical implementations through hands-on assignments and projects.
...
All submissions must follow the instructions and directory structure specified in the [`CONTRIBUTING.md`](https://github.com/adityasanapala/SoC-DSA/blob/main/CONTRIBUTING.md) file. Ensure your work is properly organized and submitted within the designated folders.
...
- 2024 (Taken by me as a mentee, for more details about this edition, reach out to me personally)
